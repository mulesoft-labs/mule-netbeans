...
public class NBPSupport {
    ...
    private static class StartAction extends AbstractRuntimeAction {
        @StaticResource
        private static final String ICON = "org/mule/tooling/netbeans/api/runtime/start.png";
    ...
    private static class StopAction extends AbstractRuntimeAction {
        @StaticResource
        private static final String ICON = "org/mule/tooling/netbeans/api/runtime/stop.png";

        public StopAction(MuleRuntime runtime) {
            super(runtime, Bundle.NBPSupport_StopAction_name(), ImageUtilities.loadImageIcon(ICON, false));
        }
