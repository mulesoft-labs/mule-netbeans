...
@MIMEResolver.NamespaceRegistration(
        ...
        mimeType = MuleConstants.MULE_MIME_TYPE,
        position = 500,
        elementName = "mule",
        elementNS = {"http://www.mulesoft.org/schema/mule/core"}
)
@DataObject.Registration(
        mimeType = MuleConstants.MULE_MIME_TYPE,
        iconBase = MuleConstants.MULE_TYPE_ICON,
        displayName = "#LBL_MuleXmlConfig_LOADER",
        position = 300
)
public class MuleXmlConfigDataObject extends MultiDataObject {
    ...
    public MuleXmlConfigDataObject(FileObject pf, MultiFileLoader loader) throws DataObjectExistsException, IOException {
        super(pf, loader);
        registerEditor(MuleConstants.MULE_MIME_TYPE, false);
    }
